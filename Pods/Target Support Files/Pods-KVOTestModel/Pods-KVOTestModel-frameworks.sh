...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ExCodable/ExCodable.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MetaCodableMacro/MetaCodable.framework"
